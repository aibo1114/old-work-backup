...
var register={
    ...
    appendHtml:function(){
        var str='<div class="regist-inner">'+
                ...
                '<input type="text" class="txt" name="pp" id="passport" tabindex="1" >'+
                '<span class="not reNameError" ></span>'+
                '</p>'+
                '<p class="formline clearfix">'+
                '<label for="password" class="hasMust">登录密码</label>'+
                '<input type="password" class="txt" name="pwd" id="password-regist" tabindex="2" >'+
                '<span class="not rePwdError"></span>'+
                '</p>'+
                '<p class="formline clearfix">'+
                '<label for="repassword" class="hasMust">重复密码</label>'+
                '<input type="password" class="txt" name="pwd" id="repassword" tabindex="3" >'+
...
register.setPassError(function(){
    register.reNameError.html('请输入6-12位字母数字下划线的组合');
})
...
register.setRepwdError(function(){
    ...
    register.rePwdError.html('请输入6-20位密码');
})
