function aclick_stat_v(a, b, c, d, e) {
    if (!document.getElementById("aclickiframe_down")) {
        ...
        f.style.display = "none", f.id = "aclickiframe_down", f.name = "aclickiframe_down", document.body.appendChild(f), f = document.createElement("iframe"), f.style.display = "none", f.id = "aclickiframe_click", f.name = "aclickiframe_click", document.body.appendChild(f);
        var g = document.createElement("a");
        g.style.display = "none", g.id = "aclickia", g.target = "blank", g.name = "aclickia", document.body.appendChild(g)
    }
    var h = "http://wan.liebao.cn/action/api/statistics.php?platform=" + a;
    if (h += "&type=" + b, h += "&game=" + c, document.getElementById("aclickiframe_click").src = h, d)if ("download" == e) document.getElementById("aclickiframe_down").src = d; else if ("blank" == e) {
        ...
        try {
            ...
            try {
                ...
                k.initEvent("click", !0, !0), i.dispatchEvent(k), i.click()
            } catch (j) {
            }
        }
    }
...
!function (a, b) {
    ...
    $.fn.extend({
        ...
        prop: function (a, c, d) {
            ...
            g && (c = $.propFix[c] || c, f = $.propHooks[c]), d !== b ? f && "set" in f && (e = f.set(a, d, c)) !== b ? e : a[c] = d : f && "get" in f && null !== (e = f.get(a, c)) ? e : a[c]
        },
        propHooks: {
            tabIndex: {
                get: function (a) {
    ...
    var KUI, version = "@VERSION@", _KEYWORDS = ["extended", "included"], _htmlDecodeDict = {
        ...
        if (b.prototype.initializer = function () {
            ...
            $.extend(!0, b, a), c.prototype = $.extend(!0, {}, a.prototype), b.prototype = new c
        }
        return b.fn = b.prototype, b.fn.parent = b, b.extend = function (a) {
            if (a) {
                var c = $.extend(!0, {}, a);
            ...
            return function () {
                var d = $.makeArray(arguments), e = d.concat(c);
                return a.apply(b, e)
            }
        }, b.proxyAll = function () {
            for (var a = $.makeArray(arguments), b = 0; b < a.length; b++)this[a[b]] = this.proxy(this[a[b]])
        }, b.fn.proxy = b.proxy, b.fn.proxyAll = b.proxyAll, b
    };
    Class.create = function (a, b) {
        var c = new Class;
        return a && c.include(a), b && c.extend(b), c
    }, KUI = new Class, KUI.Class = Class, KUI.Events = {
        bind: function (a, b) {
        ...
        isObject: function (a) {
            ...
            var c = this, d = a.replace(/%7B/gi, "{").replace(/%7D/gi, "}");
            ...
            for (var c, d, e, f, g = a.substr(a.indexOf("?") + 1), h = g.split("&"), i = h.length, j = {}, k = 0; i > k; k++)f = h[k].split("="), c = f[0], c && (d = f[1] ? b ? decodeURIComponent(f[1]) : f[1] : ""), e = j[c], "undefined" == typeof e ? j[c] = d : $.isArray(e) ? e.push(d) : j[c] = [e, d];
            return j
            ...
            for (var c in a) {
                ...
                if (d.size() > 0) {
                    ...
                    switch (e.toLocaleLowerCase()) {
                        ...
                        case"checkbox":
                            var f = a[c];
                            "object" != typeof f && (f = f.toString().split(",")), d.each(function () {
            ...
            var a = exports.location, b = this.queryToJson(a.search);
            $.isEmptyObject() && (b = {}), $.extend(b, {n: Math.random()}), a.href = a.pathname + "?" + $.param(b) + a.hash
        }, isDigits: function (a) {
            return /^\d+$/.test(a)
        }, isNumber: function (a) {
        ...
        tag: "div", initializer: function (a) {
            if (this.options = a || {}, "object" != typeof this.options)throw new Error("控制器初始化参数必须是对象");
            for (var b in this.options)this[b] = this.options[b];
            this.el || (this.el = exports.document.createElement(this.tag)), this.el = $(this.el), this.events || (this.events = this.parent.events), this.elements || (this.elements = this.parent.elements), this.events && this.delegateEvents(), this.elements && this.refreshElements(), this.proxied && this.proxyAll.apply(this, this.proxied)
        }, $: function (a) {
            return $(a, this.el)
        }, delegateEvents: function () {
            for (var a in this.events) {
                var b = this.events[a], c = this.proxy(this[b]), d = a.match(_eventSplitter), e = d[1], f = d[2];
        ...
        return a && b.include(a), b
    }, KUI._widgets = {}, KUI.Widget = Class.create({
        initializer: function () {
            this.id = KUI.guid(), this.parent._register(this), this.parent.trigger("init", this), this.bind("destroy", this._destroying)
        }, destroy: function () {
            this.trigger("destroy", this), this.parent._unregister(this.id), this.parent.trigger("destroyed", this)
    ...
    }), KUI.Widget.extend(KUI.Events), KUI.Widget.include(KUI.Events), KUI.template = KUI.T = function () {
        var a = arguments, b = this;
        if (2 == a.length) {
            if ($.isArray(a[1])) {
                for (var c = [], d = 0, e = a[1].length; e > d; d++)a[1][d]._currentIndex = d, c.push(KUI.template(a[0], a[1][d]));
                return c.join("")
            }
            return function (a, c) {
        ...
        var setting = {y: 0, M: 0, d: 0, h: 0, m: 0, s: 0};
        $.extend(setting, options || {}), obj = new Date(setting.y + obj.getFullYear(), setting.M + obj.getMonth(), setting.d + obj.getDate(), setting.h + obj.getHours(), setting.m + obj.getMinutes(), setting.s + obj.getSeconds());
        var o = {
            "M+": obj.getMonth() + 1,
            "d+": obj.getDate(),
            "h+": obj.getHours(),
        ...
        if (arguments.length > 1 && (null === b || "object" != typeof b)) {
            if (c = $.extend({encodeKey: !0}, c), null === b && (c.expires = -1), "number" == typeof c.expires) {
        ...
        if (a) {
            ...
            var b = new ZeroClipboard(a, {moviePath: "http://ptres.37.com/js/sq/plugin/ZeroClipboard.swf"});
    ...
    var d = c.ks_user;
    b.common = b.common || {}, a.extend(b.common, {
        chkSignin: function (a) {
            c.document.location.href;
            return d && "" != d.length ? !0 : (a && new b.LoginDialog({autoShow: !0}), !1)
        }, bm: function (a, d) {
            var e = a || c.location.href, f = d || document.title, g = "请您尝试同时按下Ctrl和D键收藏本页";
            try {
            ...
            var e = this.FreezingFlagName = "freeze-countdown", f = this, g = a(b), h = "freezing";
            return void 0 === c ? !!g.data(h) : (g.data(h, c), c === !0 ? g.addClass(h) : c === !1 && g.removeClass(h), void(c !== !0 || g.data(e) || 0 === d || new f.unfreezeSchedule(g, d, e, f)))
        }, isfreeze: function (a) {
            return this.freeze(a)
        }, unfreeze: function (b, c) {
            var d = this.FreezingFlagName || "freeze-countdown";
            c && c !== b.data(d) || (this.freeze(b, !1), a(b).data(d, !1))
        }, unfreezeSchedule: function (a, b, c, d) {
            var e, f = this;
            c = c || this.FreezingFlagName || "freeze-countdown", b = b || 1e3, e = setTimeout(function () {
                d.unfreeze(a, e), f = null
            }, b), a.data(c, e)
        }, mutiTpl: function (b, c) {
            var d, e, c = a.extend({innerVar: "{$inner}"}, c);
            return e = b.replace(reg_lineGap, "").replace(reg_innerTpl, function (a, b) {
                return d = b, c.innerVar
            }), {inner: d, wrap: e}
            ...
            return a = a || "modal_card_num", SC.clip(SC.byId(a))
        }, killCopy: function () {
            try {
            ...
            var d = c ? "#" : "?", e = new RegExp("[\\" + d + "|\\&]" + a + "=([^\\&|\\#|\\?]+)", "i"), f = e.exec(b);
            return f && f.length > 1 ? f[1] : null
        }, setParam: function (a, b, c, d) {
            c = c || document.location.href;
            var e = d ? "#" : "?", f = (this.getParam(a, c), a + "=" + b), g = new RegExp("(\\" + e + "|\\&)" + a + "=?[^\\&|\\#|\\?]*", "i");
            return c.match(g) ? c = c.replace(g, "$1" + f) : c.match("\\" + e) ? c = c.replace(e, e + f + "&") : c += "?" + f, c
            ...
            var d;
            if ("js" === a) d = document.createElement("script"), d.src = b, d.async = !0; else {
                if ("css" !== a)return;
                d = document.createElement("link"), d.type = "text/css", d.rel = "stylesheet", d.href = b
            }
            return c && (d.onreadystatechange = d.onload = function () {
                var a = d.readyState;
                c.done || a && !/loaded|complete/.test(a) || (c.done = !0, c())
            }), document.getElementsByTagName("head")[0].appendChild(d), this
        }
    })
}(jQuery, SQ, window);
try {
...
var ks_game_2_lb = [3, 4, 8, 10], cur_url = document.URL, is_logined = "" == ks_user ? 0 : 1, is_played = is_logined && "" != ks_user.played ? 1 : 0, tip = is_played ? "最近登录的服务器：" : "推荐您进入：", wan_url = "http://wan.liebao.cn/", shortcut_name = "金山猎豹游戏中心", shortcut_url = "http://wan.liebao.cn/?frm=shortcut", shortcut_favicon = "http://image.wan.liebao.cn/game/index/ico/favicon.ico";
...
var is_ks_game = function (a) {
    ...
    return a = encodeURIComponent(encodeURIComponent(encodeURIComponent(a))), lp = encodeURIComponent("https://login.ijinshan.com/webgame/w/" + e + ".html?style=" + c + "&btn=" + d), "https://login.ijinshan.com/?lp=" + lp + "&if=1&service=http%3A%2F%2Fi.wan.liebao.cn%2Flogin%3Fgo%3D" + a + "%26supplier_id%3D" + b
}, ks_logout_url_format = function (a) {
    return "http://wan.liebao.cn/action/logout.php?bu=" + encodeURIComponent(a)
}, logout_url = ks_logout_url_format(cur_url), chk_Num = function (a) {
    ...
    $("#wan_addfavorite").click(addfavorite), $("#wan_sethome").click(setHome)
}, Create = function () {
    ...
    try {
        var b = window.location.search, c = RegExp("" + a + "=([^&?]*)", "ig");
        return b.match(c) ? decodeURIComponent(b.match(c)[0].substr(a.length + 1)) : ""
    } catch (d) {
        return ""
    }
};
if (void 0 === Util)var Util = {};
Util.URLParser = function (a) {
    this._fields = {
        ...
        Querystring: 9,
        Fragment: 10
    }, this._values = {}, this._regex = null, this.version = .1, this._regex = /^((\w+):\/\/)?((\w+):?(\w+)?@)?([^\/\?:]+):?(\d+)?(\/?[^\?#]+)?\??([^#]+)?#?(\w*)/;
...
var Cookies = {
    aliases: {}, alias: function (a, b, c) {
        Cookies.aliases[a] = b, Cookies[a] = function (a, d) {
        ...
        a = Cookies.aliases[a] || a;
        var c = new RegExp(a + "\\s*=\\s*(.*?)(;|$)"), d = document.cookie.toString(), e = d.match(c);
        return e ? unescape(e[1]) : b
    }, erase: function (a) {
        Cookies.set(a, "", -1)
    }
}, http_referer = document.referrer, frm = getParam("frm"), referer = getParam("referer");
frm && Cookies.set("frm", frm, NaN);
var wan_url_reg = /wan\.liebao\.cn/, game_reg = /\/(.*?)\//, cur_url = document.URL, p = new Util.URLParser(cur_url), host = p.getHost(), pathname = p.getPathname(), _games = game_reg.test(pathname) ? game_reg.exec(pathname) : "", game_alias = _games.length > 1 ? "/" + _games[1] : "", cur_refer = host + game_alias, fdata = Cookies.get("fdata", ""), _fdata = fdata.split("||;"), cookie_referer = _fdata[0] ? decodeURIComponent(_fdata[0]) : "", uid = frm ? frm : _fdata[1] ? decodeURIComponent(_fdata[1]) : "", ad_type = _fdata[2] ? _fdata[2] : "", adparam = _fdata[3] ? decodeURIComponent(_fdata[3]) : "", gameid = _fdata[4] ? _fdata[4] : "", gameserverid = _fdata[5] ? _fdata[5] : "", ext = _fdata[6] ? _fdata[6] : "";
http_referer ? (p = new Util.URLParser(http_referer), host = p.getHost(), pathname = p.getPathname(), _games = game_reg.test(pathname) ? game_reg.exec(pathname) : "", game_alias = _games.length > 1 ? "/" + _games[1] : "", refer = host + game_alias, cookie_referer ? wan_url_reg.test(cookie_referer) ? cookie_referer = wan_url_reg.test(http_referer) ? refer : host : wan_url_reg.test(http_referer) || (cookie_referer = host) : cookie_referer = wan_url_reg.test(http_referer) ? refer : host) : cookie_referer = cur_refer, /i\.wan\.liebao\.cn/.test(cookie_referer) && (cookie_referer = cur_refer), referer && (cookie_referer = referer), fdata = encodeURIComponent(cookie_referer) + "||;" + encodeURIComponent(uid) + "||;" + ad_type + "||;" + encodeURIComponent(adparam) + "||;" + gameid + "||;" + gameserverid + "||;" + ext, frm || Cookies.set("frm", encodeURIComponent(uid), NaN), Cookies.set("fdata", fdata, NaN);
var liebao_pdata = "", s = getParam("src"), v = getParam("version");
liebao_pdata = http_referer ? encodeURIComponent(refer) + "||;" + encodeURIComponent(s) + "||;" + encodeURIComponent(v) : encodeURIComponent(cur_refer) + "||;" + encodeURIComponent(s) + "||;" + encodeURIComponent(v), Cookies.set("liebao_pdata", liebao_pdata, NaN), function (a, b, c) {
    ...
    d.include({
        init: function (c) {
            this.options = {
                ...
                animateForIE9Less: !1,
                animateDuring: 400
            }, a.extend(this.options, c || {}), this.el = a(this.options.el), this.tabs = a(this.options.tabs, this.el), this.panels = a(this.options.panels, this.el), this.el.attr("data-kid", this.id), this.currentIndex = this.options.index, this.tabsLen = this.panels.size(), this.isIE6 = b.navigator.userAgent.toLowerCase().match("ie 6"), this.isIE789 = b.navigator.userAgent.toLowerCase().match(/ie (7|8|9)/), this.options.noAnimateForIE6 && this.isIE6 && a.extend(this.options, {animate: {show: "show"}}), this.options.animateForIE9Less && this.isIE789 && a.extend(this.options, {
                animate: {show: "fadeIn"},
                animateDuring: 400
            }), "show" === this.options.animate.show && a.extend(this.options, {animateDuring: 0}), this.change(this.options.index), this._events(), this.options.auto && this.tabsLen > 1 && this.auto()
        }, change: function (a) {
            var b = this.options.currentClass, c = this.options.prevClass;
            this.initImg(this.panels.eq(a)), this.tabs.filter("." + c).removeClass(c), this.tabs.filter("." + b).removeClass(b).addClass(c), this.tabs.eq(a).addClass(b), this.panels.filter("." + c).removeClass(c), this.panels.filter("." + b).removeClass(b).addClass(c), this.panels.hide().eq(a).addClass(b)[this.options.animate.show](this.options.animateDuring), this.currentIndex = a, this.trigger("change", a, this)
        }, _events: function () {
            if (this.el.on(this.options.eventType, this.options.tabs, this.proxy(this._eventHandler)), this.options.auto && this.tabsLen > 1 && (this.el.on("mouseenter", this.proxy(this.stop)), this.el.on("mouseleave", this.proxy(this.auto))), this.options.controlerLeft && (this.el.on("click", this.options.controlerLeft, this.proxy(this.prePane)), this.el.on("click", this.options.controlerRig, this.proxy(this.nextPane))), this.options.lazyPreload && this.options.lazyLoadAttr) {
                var c = this;
                a(b).load(function () {
                    c.initImg(c.panels)
                })
            ...
            this.timerId || (this.timerId = b.setInterval(this.proxy(this._autoHandler), this.options.interval), this.trigger("auto", this))
        }, _autoHandler: function () {
            var a = this.currentIndex + 1;
            a >= this.tabsLen && (a = 0), this.change(a)
        }, stop: function () {
            this.timerId && (b.clearInterval(this.timerId), this.trigger("stop", this), this.timerId = null)
        }, _destroying: function () {
            this.stop(), this.el.removeAttr("data-kid"), this.tabs.unbind(this.options.eventType), this.panels.unbind()
        }, initImg: function (b) {
            var c = this.options.lazyLoadAttr, d = this.options.lazyLoadTo;
            c && b.find("[" + c + "]").each(function (b, e) {
                var f = a(e), g = f.attr(c);
                g && ("bg" === d && f.attr("style", "background-image:url('" + g + "')"), "src" === d && f.attr("src", g), f.removeAttr(c))
            })
        }, prePane: function () {
            0 === this.currentIndex ? this.change(this.tabsLen - 1) : this.change(this.currentIndex - 1), this.trigger("prev", this)
        }, nextPane: function () {
            this.currentIndex === this.tabsLen - 1 ? this.change(0) : this.change(this.currentIndex + 1), this.trigger("next", this)
        }, jumpPane: function (a) {
            return a -= 1, 0 > a || a > this.tabsLen - 1 ? !1 : (this.change(a), void this.trigger("jump", this))
        }
    }), c.Tab = d
}(jQuery, window, SQ), jQuery(function (a) {
    var b = [];
    ...
    e.include({
        init: function (c) {
            ...
            return this.opt = d = a.extend(d, c || {}), this.$obj = a(d.obj), this.$obj.length < 1 ? b.log("rollList configed wrong..") : (this.$frame = this.$obj.find(d.frame), this.$wrapper = this.$obj.find(d.wrapper), this.$indicators = this.$obj.find(d.indicators), this.$controlPrev = a(d.controlPrev), this.$controlNext = a(d.controlNext), this.itemMarker = d.itemMarkerProp || this.$wrapper.attr("data-subs") || "li", this.isVert = null !== d.isVert ? d.isVert : "true" === this.$obj.attr("data-vert") ? !0 : !1, this.frameSize = this.isVert ? this.$frame.height() : this.$frame.width(), this.offset = 0, this.wrapperSize = this.getWrapperSize(), void this.bindEvent())
        }, getWrapperSize: function () {
            if (this.isVert)return this.$wrapper.height();
            var a = this.$wrapper.find(this.itemMarker), b = a.length;
            return a.eq(0).outerWidth() * b
        }, scrollNext: function () {
            var a = this.opt.active, b = this.offset - this.frameSize;
            -b >= this.wrapperSize || (this.offset = b, this.$indicators.length > 0 && this.$indicators.find("." + a).removeClass(a).next().addClass(a), this.runScroll(), -(b - this.frameSize) >= this.wrapperSize && this.trigger("last"))
        }, scrollPrev: function () {
            var a = this.opt.active, b = this.offset + this.frameSize;
            0 > -b || (this.offset = b, this.$indicators.length > 0 && this.$indicators.find("." + a).removeClass(a).prev().addClass(a), this.runScroll(), -(b + this.frameSize) < 0 && this.trigger("first"))
        }, scrollTo: function (b) {
            var c = this.opt.active, d = a(b.currentTarget), e = d.attr(this.opt.indicatorNumProp);
            if (e) {
                var f = this.frameSize * -e;
                this.offset = f, d.siblings("." + c).removeClass(c).end().addClass(c), this.runScroll()
            }
        }, runScroll: function () {
            this.isVert ? this.$wrapper.animate({top: this.offset}, this.opt.delay) : this.$wrapper.animate({left: this.offset}, this.opt.delay), this.trigger("change", this.$indicators.find("." + this.opt.active).attr(this.opt.indicatorNumProp))
        }, bindEvent: function () {
            var b = this.opt.disabled;
            this.bind("change", function () {
                this.$controlNext.removeClass(b), this.$controlPrev.removeClass(b)
            }), this.bind("first", function () {
                this.$controlPrev.addClass(b)
            }), this.bind("last", function () {
                this.$controlNext.addClass(b)
            }), this.$obj.on("click", this.opt.controlPrev, a.proxy(this.scrollPrev, this)), this.$obj.on("click", this.opt.controlNext, a.proxy(this.scrollNext, this)), this.$indicators.on("click", this.opt.indicatorNum, a.proxy(this.scrollTo, this))
        }
    }), b.Rollist = e
}(jQuery, SQ, window, void 0), jQuery(function (a) {
    var b = [];
    a('[data-role="rollist"]').each(function (a, c) {
        b[a] = new SQ.Rollist({obj: c})
    })
}), function (a, b, c) {
    var d = new c.Class(c.Widget);
    d.include({
        init: function (b) {
            ...
            }, a.extend(this.options, b), this._t = null, this.el = a(this.options.el), this.imgs = a(this.options.imgs, this.el), this.el.attr("data-kid", this.id), this.load(), this._events()
        }, _events: function () {
            var c = this;
            a(b).scroll(function () {
                clearTimeout(c.t), setTimeout(function () {
                    c.load()
                }, 20)
            }), a(b).resize(this.proxy(this.load)), this.imgs.error(this.proxy(this._errorHandler))
        }, _destroying: function () {
            this.el.removeAttr("data-kid"), this.imgs.unbind("error"), this.imgs.removeClass(this.options.loaded)
        }, _inView: function (c) {
            var d = c.offset(), e = a(b).height(), f = a(b).scrollTop(), g = e + f + this.options.threshold;
            return g > d.top
        }, load: function () {
            var b = this.imgs.filter(":visible").not("." + this.options.loaded), c = this;
            b.each(function () {
                var b = a(this);
                c._inView(b) && c.loadImg(b)
            })
        }, loadImg: function (a) {
            a.attr("src", a.attr(this.options.srcName)), a.addClass(this.options.loaded), this.trigger("load", a)
        }, _errorHandler: function (b) {
            var c = a(b.target);
            this.trigger("error", c), this.options.error && this.options.error(c)
        }
    }), c.Lazyload = d
}(jQuery, window, SQ), !function (a, b, c) {
    var d = new c.Class(c.Widget);
    d.include({
        init: function (b) {
            this.setting = {
                ...
                autoShow: !0,
                classStyle: ""
            }, a.extend(this.setting, b), this.render(), this.events(), this.setting.autoShow && this.show()
        }, events: function () {
            var b;
            a(window).on("scroll.sq.dialog resize.sq.dialog", this.proxy(function () {
                clearTimeout(b), b = setTimeout(this.proxy(this.position), 300)
            ...
            b.preventDefault();
            var c = a(b.target), d = c.attr("data-name"), e = this.setting.buttons[d];
            e && ("function" == typeof e && e(b, this, d), e.fn && "function" == typeof e.fn && e.fn(b, this, d))
        }, render: function () {
            if (!this.el) {
                var b = '<div style="display:none;"></div>';
                this.el = a(b), this.el.appendTo(a(this.setting.appendTo)), this.el.attr("data-kid", this.id)
            }
            var d = '<div class="sq-dialog-masking" style="height:{$docHeight}px;"></div>', e = '<div class="sq-dialog {classStyle}" style="width:{$width}px;left:{$left}px;top:{$top}px;">                    <div class="sq-dialog-avatar"></div>                    <div style="position:relative;">                        <div class="sq-dialog-body">                            <div class="sq-dialog-titlebar {$notitle}">                                <h4 class="sq-dialog-titlebar-text">{$title}</h4>                                <div role="button" title="关闭" class="sq-dialog-close" aria-label="Close"><i class="ico ico-close"></i></div>                            </div>                            <div class="sq-dialog-client">                                <div class="sq-dialog-content" style="height:{$contentHeight}px;">{%=content%}</div>                            </div>                            <div class="sq-dialog-buttons {$nobutton}">{%=buttons%}</div>                </div></div></div>';
            e = e.replace("{classStyle}", this.setting.classStyle);
            var f = c.template((this.setting.mask ? d : "") + e, this._renderObj());
            this.el.html(f), this.position()
        }, position: function () {
            var b = a(".sq-dialog-masking", this.el), c = a(".sq-dialog", this.el), d = a(".sq-dialog-titlebar", this.el), e = a(".sq-dialog-buttons", this.el), f = a(window), g = c.width(), h = this.setting.height + e.outerHeight(!0) + d.outerHeight(!0) + 100, i = f.width(), j = f.height(), k = document.documentElement.scrollTop || document.body.scrollTop;
            b.height(a(document).height()), c.css({left: Math.abs(i - g) / 2, top: Math.abs(j - h) / 2 + k})
        }, _buttons: function () {
            var a = [];
            if (this.setting.buttons && c.isObject(this.setting.buttons)) {
                ...
                for (var d in this.setting.buttons) {
                    var e = this.setting.buttons[d], f = "javascript:;", g = "";
                    "string" == typeof e && (f = e, g = "target='_blank'"), a.push(c.template(b, {
            ...
            var b = a(window), d = this.setting.width, e = this.setting.height || 400, f = b.width(), g = b.height();
            return {
            ...
            switch (this.setting.type) {
                ...
                case"iframe":
                    ...
                    break;
                case"ajax":
                    c = '<div class="sq-dialog-loading"><p>正在努力加载...</p></div>', a.get(b, this.proxy(this.setContent))
            }
            return c
            ...
            a && this.el.find(".sq-dialog-titlebar-text").text(a), this.el.show(), this.position(), this.trigger("show", this)
        }, hide: function () {
            this.el.hide(), this.trigger("hide", this)
        }, _destroying: function () {
            a(".sq-dialog-btn", this.el).unbind(), this.el.remove()
        }
    }), c.Dialog = d, c.alert = function (a, b, d) {
        return new c.Dialog({
            title: d || "提示信息", buttons: {
                "确定": function (a, c) {
                    b && b(), c.destroy()
                }
            }, content: "<div class='sq-dialog-alert'>" + a + "</div>", type: "html", width: 300, height: 70
        })
        ...
        return new c.Dialog({
            ...
            }, content: a, type: "html", width: 360, height: 70
        })
    }, c.tip = function (a) {
        var b = new c.Dialog({title: null, buttons: null, content: a, type: "html", width: 400, height: 40, mask: !1});
        return setTimeout(function () {
            b.destroy()
        }, 3e3), b
    }, c.loading = function (b, d) {
        d = d || a.noop, b = b || "正在加载数据，请稍后...", "function" == typeof b && (d = b, b = "正在加载数据，请稍后...");
        var e = new c.Dialog({
            title: "提示信息",
            buttons: {
                "取消加载": function (a, b) {
    ...
    var d = b.Dialog && new b.Class(b.Dialog), e = "https://login.ijinshan.com/?lp=https%3A%2F%2Flogin.ijinshan.com%2Fwebgame%2Fw%2Fv.html%3Fstyle%3Dvdefault%26btn%3Dstyle%2Fimages%2Fvdefault.png&if=1&service=http%3A%2F%2Fi.wan.liebao.cn%2Flogin%3Fgo%3D", f = "http://" + c.document.domain + "/", g = c.document.URL, h = f + "user/register.html?bu=", i = "%26supplier_id%3D3";
    d.fn.init = function (b) {
        this.setting = {
            ...
            unlogCall: null,
            initCall: null
        }, a.extend(this.setting, b), this.regHref = this.setting.regHref || this.getRegLink(this.setting.jumpLink), this.loginFrameHref = this.setting.content || this.getLoginFrameDiaUrl(this.setting.jumpLink), this.bindEvent(), this.ksUser = this.setting.ksUser || c.ks_user, this.isLogined = this._checkLogin(), this.setting.regButton && this._insetBtn({
            _reg: {
                href: this.regHref,
                cls: this.setting.regClass,
                name: this.setting.regName
            }
        }), this.render(), this.events(), this.setting.logedNoAutoShow ? this.setting.autoShow && !this.isLogined && this.show() : this.setting.autoShow && this.show(), this.trigger("init", this)
        ...
        if (this.setting.buttons && b.isObject(this.setting.buttons)) {
            ...
            for (c in this.setting.buttons) {
                var e = this.setting.buttons[c], f = "javascript:;", g = "target='_blank'";
                "string" == typeof e ? f = e : e.href || (g = ""), a.push(b.template(d, {
                    cls: e.cls || "btn1-default",
                    name: e.name,
                    href: e.href || f,
                    target: g,
        ...
        getLoginFrameDiaUrl: function (a) {
            return a = c.encodeURIComponent(c.encodeURIComponent(c.encodeURIComponent(a))), a = e + a + i
        }, getRegLink: function (a) {
            return a = c.encodeURIComponent(a), h + a
        }, _checkLogin: function () {
            return "" != this.ksUser && this.ksUser ? (this.trigger("loged", this.ksUser, this), !0) : (this.trigger("unlog", this), !1)
        }, _insetBtn: function (b) {
            this.setting.buttons = this.setting.buttons || {}, a.extend(this.setting.buttons, b)
        }, bindEvent: function () {
            this.bind("unlog", function () {
                ...
                a.extend(this.setting, {
                    ...
                    close: {
                        cls: "btn1-orange2", name: "关闭", fn: function (a, b) {
                            b.destroy()
                        }
                    }
                })
...
}(jQuery, SQ, window), function (a, b, c) {
    "use strict";
    var d = new c.Class(c.Widget), e = "http://" + b.document.domain + "/", f = "http://image.wan.liebao.cn/", g = b.document.URL, h = {
    ...
    d.include({
        ...
        $dom: null,
        init: function (c) {
            a.extend(this.opt, c || {}), this.opt.commonFixed && (this.$container = a(this.opt.container), this.$dom = {
            ...
            }), this.checkOpt(this.opt), this._event(), this.ksUser = this.opt.ksUser || b.ks_user, this.isLogined = this._checkLogin(), this.isPlayed = this.isLogined && "" != this.ksUser.played ? 1 : 0, this.isLogined && this.showRecGame(), this.trigger("init", this)
        },
        _checkLogin: function () {
            return "" != this.ksUser && this.ksUser ? (this.trigger("loged", this.ksUser, this), this.toggleLoginModule("loged"), this.opt.commonFixed && (this._updUserInfo(), this._updLogedLinks(), this.opt.showPoints && this._updPoints(), this.opt.showCoins && this._updCoins()), !0) : (this.trigger("unlog", this), this.toggleLoginModule("unlog"), this.opt.commonFixed && this._updUnlogLinks(), !1)
        },
        showRecGame: function () {
            this.opt.showRecGame && this._updRecGame() || this._updServerListTitle()
        },
        toggleLoginModule: function (a) {
            "loged" === a ? (this.$dom.unlogC.hide(), this.$dom.logedC.show()) : (this.$dom.unlogC.show(), this.$dom.logedC.hide())
        },
        _updRecGame: function () {
            for (var a, b, c, d = this.isPlayed ? this.ksUser.play_history : this.ksUser.new_server, g = [], h = "", i = 0, j = d.length; j > i && 4 > i; i++) {
                var k = "", l = d[i], m = null;
                this.opt.recGameStat && (k = 'data-position=\'{"e2":"sydl","e3":"sydl-f' + (i + 1) + "\"}'"), m = this.isPlayed ? l.servers[0] : l, a = m.sid, m.ext && m.ext.CATE_NAME ? (c = m.ext.EXT_SID, b = m.ext.CATE_NAME) : (c = m.sid > 1e4 ? "抢鲜" + (m.sid - 1e4) : m.sid, b = m.server_name), h = this.getHtml(this.tplRecGame, {
        ...
        _updUnlogLinks: function () {
            this.$dom.loginFrame.attr("src", this.getKsLoginFrameUrl(g, 3, "loginpanel_v2", "style/images/loginpanel_v2.png", "loginpanel_v2")), this.$dom.btnReg.attr("href", h.reg + b.encodeURIComponent(g))
        },
        ...
        getKsLoginFrameUrl: function (a, c, d, e, f) {
            var a = b.encodeURIComponent(b.encodeURIComponent(b.encodeURIComponent(a))), g = b.encodeURIComponent(h.jsLogin + "/webgame/w/" + f + ".html?style=" + d + "&btn=" + e);
            return h.jsLogin + "/?lp=" + g + "&if=1&service=http%3A%2F%2Fi.wan.liebao.cn%2Flogin%3Fgo%3D" + a + "%26supplier_id%3D" + c
        },
        getHtml: function (a, b) {
            var c;
            if (b) {
                for (c in b)a = a.replace("{$" + c + "}", b[c]);
                return a
            }
        },
        ...
        _event: function () {
            ...
            this.bind("init", this.opt.initCall || function () {
                ...
                b.preventDefault(), a.ksUser && a._showSignArriveFrame()
            })
        }
    }), c.Login = d
}(jQuery, window, SQ), jQuery(function (a) {
    ...
    if (b.length > 0) {
        new SQ.Login({container: b})
    }
}), function (a, b, c) {
    var d = new b.Class(b.Widget), e = c.document.domain;
    d.extend({
        urlBase: "http://" + e + "/",
        ...
        father: d, init: function (b) {
            this.opt = {
                ...
                isStatMark: !0
            }, this.opt = a.extend(this.opt, b || {}), this.$obj = a(this.opt.obj), this.getNewServerInfo(this.opt.reqLink + this.opt.amount, a.proxy(function (a) {
                this.updNeweServer(this.compositeNewServerInfo(a)), this.opt.endCall && this.opt.endCall()
            }, this))
        }, getNewServerInfo: function (b, c) {
            a.ajax({url: b, dataType: "json"}).done(function (a) {
            ...
            if (a instanceof Array) {
                ...
                for (b = 0; d > b; b++) {
                    var g = a[b], h = {}, i = g.START_TIME.split(" ");
                    h.date = i[0].replace(e, ""), h.time = i[1].replace(f, ""), h.gameSiteUrl = this.father.urlBase + g.GAME_ALIAS + "/", h.gameName = g.GAME_NAME, h.sidDesc = g.SID + this.father.tplSidDesc, h.labelLogo = "", h.gameServerUrl = "", h.strongClass = "", g.ext && g.ext.CATE_NAME && (h.sidDesc = g.ext.CATE_NAME + g.ext.EXT_SID + this.father.tplSidDesc), "1" === g.ISHOT ? h.labelLogo = this.father.tplLabelHot : "2" === g.ISHOT && (h.labelLogo = this.father.tplLabelNew), this.opt.isLogin ? h.gameServerUrl = this.father.urlBase + "game_frame/play_" + g.GAME_ID + ".php?sid=" + g.SID : h.gameServerUrl = h.gameSiteUrl + "server_list.html", "1" === g.STATUS ? h.strongClass = this.father.tplStrongClass : "3" === g.STATUS && (h.gameServerUrl = "javascript:;", h.sidDesc = this.father.tplServerMaint), "2" === g.SERVER_TYPE && (h.sidDesc = g.LINE_NAME), c.push(h)
                }
                return c
            }
            ...
            for (b = 0; c > b; b++) {
                var e = a[b], f = "";
                e = this.composStatMark(e, b), f = this.father.getHtml(this.father.tplNewServer, e), d.push(f)
            }
            this.$obj.html(d.join(""))
        }, composStatMark: function (b, c) {
            var d = "", e = "";
            return this.opt.isStatMark && (d = this.father.getHtml(this.father.tplStatMark, {statNum: c + 1}), e = this.father.getHtml(this.father.tplStatMark2, {statNum: c + 1})), a.extend(b, {
                statServ: d,
                statSite: e
            })
        }, bindEvent: function () {
    ...
    "use strict";
    var d = function () {
        this.data = [], this.put = function (a, b) {
            this.data[a] = b
        }, this.get = function (a) {
            return this.data[a]
        ...
        serverInfo: function (a, b) {
            var c, d, f, g = this, h = [], i = "gid-" + a, j = null, k = null, l = function () {
                for (j = e.get(i), k = j.data.servers, c = 0, d = k.length; d > c; c++) {
                    var a, g;
                    1 !== +k[c].STATUS && (k[c].SERVER_TYPE > 10 ? (a = k[c].LINE_NAME, g = "") : (a = k[c].SERVER_NAME, g = "(" + k[c].SID + "服)"), f = '<li class="gift-select-item" data-servername="' + a + g + '" data-sid="' + k[c].SID + '" role="button">' + a + g + "</li>", h.push(f))
                }
                b.nextAll(".gift-select-menu").html(h.join("")).show()
            };
            e.get(i) ? l() : g.callApi(g.url.serverUrl, {gid: a, ts: "-1"}, function (a) {
                    e.put(i, a), l()
                })
        },
        getCard: function (b) {
            ...
            d.callApi(d.url.cardUrl, f, function (f) {
                1 === +f.code ? (c = a("#gift-alert-success-tpl").html().replace("{$gamename}", b.gamename).replace("{$servername}", b.servername).replace(/\{\$cardnum\}/g, f.data.card_number), d.showScuessDialog(c, f.data.card_number, e)) : (c = a("#gift-alert-fail-tpl").html(), d.showFailDialog(c))
            })
        },
        showScuessDialog: function (a, c, d) {
            var e = null, f = "btn1-orange2", g = new b.Dialog({
                autoShow: !1,
                title: "礼包领取成功",
                content: a,
                width: 510,
                height: 80,
                buttons: {"一键复制": {cls: f}, "进入游戏": {cls: "btn1-blue2", href: d}}
            });
            g.bind("show", function (a) {
                var d = a.el.find("." + f);
                d.attr("data-clipboard-text", c), e = b.clip(d[0])
        ...
        showFailDialog: function (a) {
            ...
            new b.Dialog({
                ...
                buttons: {
                    "返回页面": {
                        cls: "btn1-orange2", fn: function (a, b) {
                            b.destroy()
                        }
                    }, "在线客服": {cls: "btn1-blue2", href: c}
                }
            })
        },
        events: function () {
            var d, e, f, g = this, h = a(document), i = a(".gift-select-menu"), j = (a("#mark"), a(".gift-alert"), navigator.userAgent.toLowerCase());
            h.on("click", ".gift-select-sid", function (b) {
                var c = a(this), e = c.siblings(".gift-select-menu");
                return "block" === e.css("display") ? e.hide() : (i.hide(), b.stopPropagation(), d = c.data("gameid"), void g.serverInfo(d, c))
            }).on("click", ".gift-select-menu li", function (b) {
                b.preventDefault(), e = a(this).data("sid"), f = a(this).data("servername"), a(this).parents(".gift-select").find(".gift-select-get").data("sid", e).data("servername", f), a(this).parents(".gift-select").find(".gift-select-sid").prop("title", f).html(f)
            }).on("click", ".gift-select-get", function (d) {
                d.preventDefault();
                var e = a(this).data("option"), f = {
                    gid: e.gameid,
                    sid: a(this).data("sid"),
                    type: e.type,
                    gamename: e.gamename,
                ...
                if (c.ks_user && "" != c.ks_user) {
                    if (!f.sid)return b.alert("请选择您游戏角色所在的对应服务器！");
                    g.getCard(f)
                } else new b.LoginDialog({autoShow: !0})
    ...
    b.gift = f
}(jQuery, SQ, window), function ($, SQ, window) {
    "use strict";
    var domain = window.document.domain, cdnBase = "http://image.wan.liebao.cn/", isLogin = window.ks_user && "" != window.ks_user, $dom = null, url = {
        domain: "http://" + domain + "/",
    ...
    }, common = SQ.common, main = {
        init: function () {
            this.initLazyImage(), this.kv($dom.kv), this.initNewServer($dom.newServerOpen, $.proxy(this.initRollListOpen, this), url.newServerOpen), this.initGetGift($dom.giftModule), this.initCouplet($dom.couplet), window.wanCommonPart(), this.serverTab($("#new_server_Container")), "index" === $dom.body.data("page") && this.initQD()
        }, initQD: function () {
            var a = SQ.getParam("referer");
            0 === window.ks_user.length && a && SQ.common.loadResouse("js", url.qdDialogUrl, function () {
                SQ.qdDialog.show()
            })
            ...
            return SQ.Rollist && new SQ.Rollist({obj: $dom.serverContentOpen})
            ...
            if (SQ.Tab && a && a.length) {
                ...
                d.bind("change", function (a) {
                    ...
                    "expect" !== e || c || (b.initNewServer($dom.newServerExpect, $.proxy(b.initRollListExpect, b), url.newServerExpect), c = !0)
                })
            }
        }, initLazyImage: function () {
            if (SQ.Lazyload) {
                var a = {threshold: 100, imgs: ".lazy"};
                new SQ.Lazyload(a)
            }
        }, kv: function (a) {
            if (SQ.Tab && a && a.length) {
                ...
                return tpl ? void $.getScript("/cache/couplet.js", function () {
                        ...
                        if (couplet && 0 !== couplet.length) {
                            for (var i = 0; i < couplet.length; i++) {
                                var item = couplet[i];
                                item.side = i + 1;
                                var e2 = item.position.split("-")[0], e3 = item.position;
                                item.position = '{"e2":"' + e2 + '","e3":"' + e3 + '"}', html += SQ.T(tpl, couplet[i])
                            }
                            el.html(html)
                        }
        ...
        b && $dom.doc.on("click", "[data-position]", function () {
            var c = a(this).data("position"), d = {e1: b, e2: c.e2, e3: c.e3};
    ...
    p.prototype.setCurrent = function (b) {
        ...
        return a = "boolean" == typeof a ? a : !!a, r.call(this, a), this.options.forceHandCursor = a, this
    };
    var r = function (a) {
    ...
    p.prototype.resetBridge = function () {
        return null === a ? this : (this.htmlBridge.style.left = "-9999px", this.htmlBridge.style.top = "-9999px", this.htmlBridge.removeAttribute("title"), this.htmlBridge.removeAttribute("data-clipboard-text"), h(a, this.options.activeClass), a = null, this.options.text = null, this)
        ...
        if (!a)return !1;
        var b = j(a);
        return this.htmlBridge.style.top = b.top + "px", this.htmlBridge.style.left = b.left + "px", this.htmlBridge.style.width = b.width + "px", this.htmlBridge.style.height = b.height + "px", this.htmlBridge.style.zIndex = b.zIndex + 1, this.setSize(b.width, b.height), this
        ...
        return this.handlers.noflash && !p.detectFlashSupport() && this.receiveEvent("onNoFlash", null), this
        ...
        switch (b) {
            case"load":
                if (c && parseFloat(c.flashVersion.replace(",", ".").replace(/[^0-9\.]/gi, "")) < 10)return void this.receiveEvent("onWrongFlash", {flashVersion: c.flashVersion});
