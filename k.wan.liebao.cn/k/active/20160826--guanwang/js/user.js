...
var login={
    ...
    appendHtml:function(){
        ...
        var str='<p class="login-error">用户名或密码错误</p>'+
                ...
                '<p class="login-btn">'+
                '<a href="javascript:void(0)" hidefocus="true" id="yl-login">马上登录</a>'+
...
var register={
    ...
    appendHtml:function(){
        var str='<div class="regist-inner">'+
                ...
                '<input type="text" class="txt" name="pp" id="email" tabindex="1" placeholder="请输入有效邮箱，找回密码时使用（选填)">'+
                '</p>'+
                '<p class="formline clearfix">'+
                '<label for="realname">姓名</label>'+
                '<input type="text" class="txt" name="pp" id="realname" tabindex="1" placeholder="选填">'+
                '</p>'+
                '<p class="formline clearfix">'+
                '<label for="cardid">身份证</label>'+
                '<input type="text" class="txt" name="pp" id="cardid" tabindex="1" placeholder="选填">'+
                '</p>'+
                '<p class="rmline-reg">'+
