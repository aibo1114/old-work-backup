...
(function() {
  ...
  _listOpt = {
    ...
    events: {
      'click .toolbar .sh': function(e) {
        var c, et, frm, passport, st, toolbar;
        c = this.collection;
        toolbar = this.$('.toolbar');
        frm = this.$('.toolbar').find("[name='frm']").val();
        passport = this.$('.toolbar').find("[name='passport']").val();
    ...
    listOpt: {
      ...
      events: {
        'click .toolbar .sendBtn': function() {
          var c;
          c = this.collection;
          c.setCriteria(util.setQ(this.$el, 'cpsuser', 'frm'));
          return c.resetFetch();
        }
      }
    },
    ...
    listOpt: {
      ...
      events: {
        'click .toolbar .sendBtn': function() {
          var c;
          c = this.collection;
          c.setCriteria(util.setQ(this.$el, 'cpsuser'));
          return c.resetFetch();
        }
      }
    },
    ...
    listOpt: {
      ...
      events: {
        'click .toolbar .sendBtn': function() {
          var c;
          c = this.collection;
          c.setCriteria(util.setQ(this.$el, 'cpsuser', 'stime', 'etime'));
          return c.resetFetch();
        }
      }
    }
