...
(function() {
  var bid, brand, card, cid, pid, product, pubAccount, role, seckilling, user;
      ...
      product: [
        {
          ...
          evaluation: ['aaa111', 'bbb222', 'ccc333'],
          contact: 13870894526
        }
      ],
      price: 12000,
  ...
  module.exports = {
    community: {
      ...
      url: app.env ? 't.ear.com' : 'ear.postenglishtime.com',
      nav: [
        {
          'label': '首页',
          'href': '/'
