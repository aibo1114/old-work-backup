    ...
    prop: [
      {
        ...
        attrs: {
          ...
          editProp: [_ep('title'), _ep('phone'), _ep('address')],
          panelOpt: {
            entity: 'shop',
            noStr: '请按照店名查找'
          }
        }
      }, m._link('username'), m.user.prop.codeBy('gender'), _ep('row'), _ep('phone'), m._text('qq'), {
        code: 'exp',
        type: 'text',
        xtype: 'dTime',
        attrs: {
      ...
      }), _ep('description'), m._itemTable('comment'), _ep('content:status'), m._pic('head')
    ],
    listOpt: {
      btns: ['exExcel', 'topAdd']
    },
