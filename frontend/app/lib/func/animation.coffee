...
onEndAnimation = (el, callback, animEndEventName = 'webkitAnimationEnd') ->
    onEndCallbackFn = (ev) ->
...
#        onEndAnimation if classie.has(el, 'cbutton--complex') then el.querySelector('.cbutton__helper') else el, ->
